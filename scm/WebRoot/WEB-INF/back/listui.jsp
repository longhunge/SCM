        ...
        <div class="row">        
                <div class="col-lg-12">
                    <div class="panel panel-default">
						...
						<tr>
                        	<td>   
                                 <a href="<%=basePath %>back/user_addui.action"> <button type="button" class="btn btn-inline btn-default">增加</button></a>
                            </td>
							<td>	
                                 <button type="button" class="btn btn-inline btn-default" onclick="doDeleteAll()">批量删除</button>                  
                            </td>
							<td>
                                  <button type="button" class="btn btn-inline btn-default" onclick="doExportExcel()">导出</button>
                            </td>
							...
							<td>
                               	<button type="button" class="btn btn-inline btn-default" onclick="doImportExcel()">导入</button>
                            </td>
                            </tr>
                            </table>
							</div>
